...
Deployed Application: [Kudos Board Deployed Site](https://kudos-board-api.onrender.com/)
...
Yup, Express, Prisma, React, React Router

### Shout out

Give a shout out to somebody from your cohort that especially helped you during your project. This can be a fellow peer, instructor, TA, mentor, etc.

The project REVIEWERS are the best! Thank you.
